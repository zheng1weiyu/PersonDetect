...
class PersonDetect():
    ...
    def detect(self,frame,):
        ...
        # Set Dataloader
        # print('128:frame.shape',frame.shape)
...
if __name__ == "__main__":
    ...
    match_info = personDetectModel.detect(frame)
    print(match_info)
    ...
    #             detect_model.detect(frame)
                ...
                # image=detect_model.detect(frame)
                # detect_model.drawDetectImg(image)
